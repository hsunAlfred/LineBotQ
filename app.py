...
def getMRTSoundMessage():
    ...
    message["originalContentUrl"] = F"/app/static/mrt_sound.m4a"
    import audioread
...
def getTotalSentMessageCount():
    ...
    #url = "https://api.line.me/v2/bot/message/delivery/reply?date=20210112"
    ...
    if request.method == 'GET':
        ...
        if code and state:
            ...
            FormData = {"grant_type": 'authorization_code', "code": code,
                        "redirect_uri": F"{end_point}/line_login", "client_id": client_id, "client_secret": client_secret}
